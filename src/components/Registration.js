      ...
      <Container className="py-3">
        <div className="card">
          ...
          <div className="right">
            <h1>Welcome!</h1>
            <p>
              Whether you've a professional looking to advance your career, an
              employer seeking top-tier talent, or an enthusiast eager to
              explore a marketplace of skills, Kalena Market is your
              destination.{" "}
            </p>
